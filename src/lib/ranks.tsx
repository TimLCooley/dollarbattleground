...
// Enlisted ranks climb by LOGIN COUNT; Officers are commissioned by BUYING
// ($5/$10 actions) and climb by purchase count. Thresholds are tunable.
...
export interface Rank {
  ...
  req: number; // enlisted: min logins; officer: min buys
